    ...
    <div class="container py-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-2">Realisasi KPI Divisi - Response</h5>
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <form method="GET" action="{{ route('realisasi-kpi-divisi-response.index') }}"
                        ...
                        <a href="{{ route('realisasi-kpi-divisi-response.index', ['per_page' => $perPage]) }}"
                                                ...
                                                @if ($needsReinput)
                                                    <div class="d-flex align-items-center flex-nowrap gap-2">
                                                        <a class="btn btn-icon btn-sm btn-primary"
                                                            href="{{ route('realisasi-kpi-divisi-response.create', ['user_id' => $u->id, 'bulan' => $bulan, 'tahun' => $tahun]) }}"
