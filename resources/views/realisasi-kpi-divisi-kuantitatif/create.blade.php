    ...
    <div class="container py-4">
        <div class="card border-0 shadow-sm rounded">
            <div class="card-header d-flex justify-content-between align-items-center flex-wrap gap-2">
                <h5 class="mb-0"><i class="bx bx-bar-chart-alt-2 me-1"></i>Input Realisasi KPI Divisi Kuantitatif - {{ $user->full_name }} ({{ $bulanList[$bulan] }} {{ $tahun }})
                </h5>
                ...
                <form method="POST" action="{{ route('realisasi-kpi-divisi-kuantitatif.store') }}">
                    ...
                    <div class="d-flex justify-content-end border-top mt-3 pt-3">
                        <button type="submit" class="btn btn-primary">
                            <i class="bx bx-save me-1"></i> Ajukan
                        </button>
                    </div>
                </form>
            </div>
