    ...
    <div class="container py-4">
        <div class="card">
            <div class="card-header">
                <h5 class="mb-2">Realisasi KPI Divisi - Kuantitatif</h5>
                ...
                <div class="d-flex align-items-center justify-content-between flex-wrap gap-2">
                    ...
                    <form method="GET" action="{{ route('realisasi-kpi-divisi-kuantitatif.index') }}"
                        ...
                        <a href="{{ route('realisasi-kpi-divisi-kuantitatif.index', ['per_page' => $perPage]) }}"
                                            ...
                                            @if ($me->role === 'leader')
                                                @if ($needsReinput)
                                                    <div class="d-flex align-items-center flex-nowrap gap-2">
                                                        <a class="btn btn-icon btn-sm btn-primary"
                                                            href="{{ route('realisasi-kpi-divisi-kuantitatif.create', ['user_id' => $u->id, 'bulan' => $bulan, 'tahun' => $tahun]) }}"
                                                ...
                                                @else
                                                    <a class="btn btn-icon btn-sm btn-outline-secondary"
                                                        href="{{ route('realisasi-kpi-divisi-kuantitatif.show', $r->id) }}"
